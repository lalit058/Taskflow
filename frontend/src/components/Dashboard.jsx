...
const Dashboard = ({ user, token, onLogout, onUpdateUser }) => {
  ...
  const handleSave = async (formData) => {
    ...
    const savePromise = editingTask
      ? updateTask({
          variables: { id: editingTask.id || editingTask._id, ...variables },
        })
      ...
      <main className="mx-auto p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            >
              <div
                className={`flex items-center justify-between ${s.color} mb-2`}
              >
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {user?.role === "admin"
                ? "Viewing all tasks across organization"
